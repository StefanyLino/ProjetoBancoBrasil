...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($id) {
        ...
        $sql = "UPDATE produtos SET fornecedor_id=?, nome=?, descricao=?";
        $params = [$fornecedor_id, $nome, $descricao];
        if($imagem) {
            $sql .= ", imagem=?";
            $params[] = $imagem;
        }
        ...
        $sql = "INSERT INTO produtos (fornecedor_id, nome, descricao, imagem) VALUES (?, ?, ?, ?)";
        $stmt = $conn->prepare($sql);
        $stmt->bind_param("isss", $fornecedor_id, $nome, $descricao, $imagem);
    ...
    <div class="page">
        <div class="card">
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <select  class="campo" name="fornecedor_id" required>
                ...
                <input placeholder="Digite aqui..."  class="campo" type="text" name="nome" value="<?php echo $produto['nome'] ?? ''; ?>" required>
            
                <label for="descricao">Descrição:</label>
                <textarea placeholder="Digite aqui..."  class="campo" name="descricao"><?php echo $produto['descricao'] ?? ''; ?></textarea>
                ...
                <?php endif; ?>
                <br>
                <button class="btn" type="submit"><?php echo $produto ? 'Atualizar' : 'Cadastrar'; ?></button>
            </form>
        </div>
        ...
        <div class="botao-container"><a href="index.php" class="btn">Voltar</a></div>
    </div>
</body>
</html>